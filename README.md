...
---
<div style="display:flex;justify-content:space-between;align-items:stretch;flex-wrap:wrap;gap:10px;width:100%;box-sizing:border-box;"> <a href="#quick-start" style="flex:1;text-decoration:none;border:1px solid #d0d7de;border-radius:8px;min-width:150px;margin:5px;padding:10px 0;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#fff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1f2937;"> <div style="font-size:28px;">🚀</div> <div style="font-weight:700;font-size:16px;">Quick Start</div> <div style="font-size:14px;color:#0969da;">Installation & Setup</div> </a> <a href="https://off-by-some.github.io/fynx/" style="flex:1;text-decoration:none;border:1px solid #d0d7de;border-radius:8px;min-width:150px;margin:5px;padding:10px 0;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#fff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1f2937;"> <div style="font-size:28px;">📚</div> <div style="font-weight:700;font-size:16px;">Read the Docs</div> <div style="font-size:14px;color:#0969da;">Full API Reference</div> </a> <a href="https://github.com/off-by-some/fynx/blob/main/examples/" style="flex:1;text-decoration:none;border:1px solid #d0d7de;border-radius:8px;min-width:150px;margin:5px;padding:10px 0;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#fff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1f2937;"> <div style="font-size:28px;">💡</div> <div style="font-weight:700;font-size:16px;">Examples</div> <div style="font-size:14px;color:#0969da;">Code Samples</div> </a> <a href="https://github.com/off-by-some/fynx/issues" style="flex:1;text-decoration:none;border:1px solid #d0d7de;border-radius:8px;min-width:150px;margin:5px;padding:10px 0;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#fff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1f2937;"> <div style="font-size:28px;">🐛</div> <div style="font-weight:700;font-size:16px;">Support</div> <div style="font-size:14px;color:#0969da;">Report Issues</div> </a> </div>
